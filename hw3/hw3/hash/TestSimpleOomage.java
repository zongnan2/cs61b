...
public class TestSimpleOomage {
    ...
    public void testHashCodePerfect() {
         ...
         */
        SimpleOomage ooA = new SimpleOomage(5, 25, 80);
        SimpleOomage ooB = new SimpleOomage(10, 15, 85);
        SimpleOomage ooC = new SimpleOomage(40, 50, 20);
        SimpleOomage ooA2 = new SimpleOomage(5, 25, 80);
